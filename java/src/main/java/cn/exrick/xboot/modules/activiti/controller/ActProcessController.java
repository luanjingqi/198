...
import cn.exrick.xboot.modules.activiti.entity.*;
...
public class ActProcessController {
    ...
    public Result<Object> editNodeUser(@RequestParam String nodeId,
                                       ...
                                       @ApiParam("是否勾选操作人的部门负责人") @RequestParam(required = false) Boolean chooseDepHeader){
        ...
        if(chooseDepHeader!=null&&chooseDepHeader){
            ActNode actNode = new ActNode();
            actNode.setNodeId(nodeId);
            actNode.setType(ActivitiConstant.NODE_DEP_HEADER);
            actNodeService.save(actNode);
        }
