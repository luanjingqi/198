      ...
      <Tabs v-model="tabName" :animated="false">
        <TabPane label="Github" name="github">
          <Row @keydown.enter.native="handleSearch">
            <Form ref="githubForm" :model="github" inline :label-width="100" class="search-form">
        ...
        <TabPane label="QQ" name="qq">
          <Row @keydown.enter.native="handleSearch">
            <Form ref="qqForm" :model="qq" inline :label-width="100" class="search-form">
              <Form-item label="社交账号昵称" prop="username">
                <Input
                  type="text"
                  v-model="qq.username"
        ...
        <TabPane label="微博" name="weibo">
          <Row @keydown.enter.native="handleSearch">
            <Form ref="weiboForm" :model="weibo" inline :label-width="100" class="search-form">
              <Form-item label="社交账号昵称" prop="username">
                <Input
                  type="text"
